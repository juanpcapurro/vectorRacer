...
//        def vectorracerrest.lobby = new Lobby()
//        vectorracerrest.lobby.addPlayer(charlyCompleto)
//        vectorracerrest.lobby.addPlayer(damiCompleto)
//        charlyCompleto.toggleReady()
//        damiCompleto.toggleReady()
//        vectorracerrest.lobby.chooseTrack(new RaceTrack())
//        vectorracerrest.lobby.save(failOnError:true)
